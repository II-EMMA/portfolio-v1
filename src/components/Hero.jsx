...
const Hero = () => {
  const jsonLd = {
    ...
    "@type": "Person",
    name: "EMMA",
    jobTitle: "Pixel-Perfect UI Specialist",
    url: "https://yourdomain.com",
    sameAs: [
      "https://linkedin.com/in/emma",
      "https://github.com/II-EMMA",
      "https://www.instagram.com/imanahmmedd",
    ],
    description:
      "I help brands and teams achieve flawless visual fidelity — turning any Figma design or live website into a reusable, SEO‑ready Next.js template with zero compromise on design accuracy, performance, or accessibility.",
  };
  ...
  return (
    <>
      ...
      <div className="grid md:grid-cols-2 place-items-center max-w-[1200px] mx-auto md:mt-14 mt-12 relative lg:text-start text-center text-wrap pt-24">
        <div className="px-3">
          <TypeAnimation
            sequence={[
              "Frontend Developer",
          ...
          <p className="dark:text-gray-300 text-gray-700">
            ...
            <span className="italic">zero compromise</span> on design accuracy,
          ...
          <div className="self-start flex lg:flex-row flex-col items-center  gap-4 mt-6 mb-4 md:mb-0">
            <Link
              ...
              className="transform transition-transform hover:scale-105 hover:shadow-lg
                ...
                border border-purple-500 rounded-xl text-center"
            >
              Download CV
            </Link>
            ...
            >
              ...
              <AiOutlineGithub />
              <Link
                href="www.linkedin.com/in/e-m-666759381"
                rel="noopener noreferrer"
                target="_blank"
              >
                <AiOutlineLinkedin />
